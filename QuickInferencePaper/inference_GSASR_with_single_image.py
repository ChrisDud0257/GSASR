...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_sr_path', type=str, default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/figures/QuickInferenceExpResults', help='output folder')
    parser.add_argument('--scale', type = float, default = 4.29)
    parser.add_argument('--suffix', type = str, default = 'GSASR')
    parser.add_argument('--encoder_name', type = str, default = 'SwinIR') # EDSR-Baseline, RDN or SwinIR
