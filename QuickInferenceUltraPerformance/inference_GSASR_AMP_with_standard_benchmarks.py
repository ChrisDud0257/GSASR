...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_sr_path', type=str, default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/figures/QuickInferenceExpResultsUltra/Benchmark', help='output folder')
