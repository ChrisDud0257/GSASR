...
def main(args):
    ...
    if args.encoder_name == 'HATL':
        ...
        raise ValueError(f"args.encoder_name-{args.encoder_name} must be HATL")
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--encoder_path',
        type=str,
        default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/pretrained_models/UltraPerformance/HATL-SA1B/net_g.pth')
    parser.add_argument(
        '--decoder_path',
        type=str,
        default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/pretrained_models/UltraPerformance/HATL-SA1B/net_fea2gs.pth')
    ...
    parser.add_argument('--save_sr_path', type=str, default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/figures/QuickInferenceExpResultsUltra', help='output folder')
    parser.add_argument('--scale', type = float, default = 4.29)
    parser.add_argument('--suffix', type = str, default = 'GSASR')
    parser.add_argument('--encoder_name', type = str, default = 'HATL') # Must be HATL
    ...
    ### For HATL, please set denominator to 16
