...
def main(args):
    ...
    cv2.imwrite(os.path.join(args.save_sr_path, f'{imgname}_{args.encoder_name}_{args.scale}{ext}'), output)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--encoder_path',
        type=str,
        default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/pretrained_models/AMP/EDSR-Baseline-Train-with-DF2K/net_g.pth')
    # parser.add_argument(
    #     '--encoder_path',
    #     type=str,
    #     default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/pretrained_models/AMP/RDN-Train-with-DF2K/net_g.pth')
    # parser.add_argument(
    #     '--encoder_path',
    #     type=str,
    #     default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/pretrained_models/AMP/SwinIR-Train-with-DF2K/net_g.pth')
    parser.add_argument(
        '--decoder_path',
        type=str,
        default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/pretrained_models/AMP/EDSR-Baseline-Train-with-DF2K/net_fea2gs.pth')
    # parser.add_argument(
    #     '--decoder_path',
    #     type=str,
    #     default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/pretrained_models/AMP/RDN-Train-with-DF2K/net_fea2gs.pth')
    # parser.add_argument(
    #     '--decoder_path',
    #     type=str,
    #     default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/pretrained_models/AMP/SwinIR-Train-with-DF2K/net_fea2gs.pth')
    parser.add_argument('--input_img_path', type=str, default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/figures/QuickInferenceExp/tree.png', help='input test image folder')
    parser.add_argument('--save_sr_path', type=str, default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/figures/QuickInferenceExpResultsAMP', help='output folder')
    parser.add_argument('--scale', type = float, default = 4.29)
    ...
    ### For EDSR-Baseline and RDN, please set denominator to 12, for SwinIR, please set denominator to 16
