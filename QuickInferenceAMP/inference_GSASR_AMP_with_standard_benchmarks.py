...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_img_path', type=str, default='/home/notebook/data/sharedgroup/RG_YLab/aigc_share_group_data/chendu/dataset/AnyScaleTestBicubic/DIV2K100/x4/LR', help='input test image folder')
    parser.add_argument('--save_sr_path', type=str, default='/home/notebook/code/personal/S9053766/chendu/FinalUpload/GSASR/figures/QuickInferenceExpResultsAMP/Benchmark', help='output folder')
